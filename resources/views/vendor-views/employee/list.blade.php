            ...
            <div class="search--button-wrapper justify-content-end">
                <form  class="search-form">
                    ...
                    <div class="input-group input--group">
                        <input  value="{{  request()?->search ?? null }}"  type="search" name="search" class="form-control" placeholder="{{ translate('messages.Eg:') }} {{translate('Search by name or email..')}}" aria-label="Search">
