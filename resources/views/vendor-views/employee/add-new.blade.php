                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="f_name" class="form-control" id="f_name"
                                    placeholder="{{ translate('messages.Eg:') }} Sakeef Ameer" value="{{ old('f_name') }}"
                                    required>
                            </div>
                            <div class="form-group">
                                <label class="input-label text-capitalize"
                                ...
                                <input type="text" name="l_name" class="form-control" id="l_name"
                                    value="{{ old('l_name') }}" placeholder="{{ translate('messages.Eg:') }} Prodhan"
                                    >
                            </div>
                            <div class="form-group">
                                <label class="input-label text-capitalize"
                                ...
                                <input type="tel" name="phone" value="{{ old('phone') }}" class="form-control"
                                    id="phone" placeholder="{{ translate('messages.Eg:') }} +88017********" required>
                            </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <input type="email" name="email" value="{{ old('email') }}"
                                                ...
                                                placeholder="{{ translate('messages.Eg:') }} ex@gmail.com" required>
                                        </div>
                                        <div class="col-md-4">
