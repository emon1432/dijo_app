            ...
            data-original-title="{{translate('messages.minimum_processing_time_warning')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.minimum_processing_time_warning')}}"></span></label>
                        ...
                        <div class="col-sm-4 col-12">
                            <div class="">
                                ...
                                <input type="number" id="minimum_stock_for_warning" name="minimum_stock_for_warning"  min="0" max="999999999" class="form-control" placeholder="{{ translate('messages.Eg: 5') }}" value="{{$store?->storeConfig?->minimum_stock_for_warning??''}}">
                            </div>
                        </div>
                        @endif
