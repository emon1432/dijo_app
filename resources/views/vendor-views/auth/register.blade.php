                    ...
                    <div class="col-lg-6">
                            ...
                            <div class="mb-4">
                                <div class="form-group mb-0">
                                    ...
                                    <textarea type="text" id="address" name="address[]"
                                        placeholder="{{translate('Eg: ABC Company')}}"
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" id="latitude" name="latitude" class="form-control __form-control"
                                placeholder="{{ translate('messages.Eg:') }} -94.22213" value="{{ old('latitude') }}"
                                required readonly>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="tel" id="phone" name="phone" class="form-control __form-control"
                                placeholder="{{ translate('messages.Eg:') }} 017********" value="{{ old('phone') }}"
                                required>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-12 col-lg-4">
                        <div class="form-group">
                            ...
                            <input type="email" id="email" name="email" class="form-control __form-control"
                                placeholder="{{ translate('messages.Eg:') }} ex@example.com" value="{{ old('email') }}"
                                required>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12 col-lg-4">
