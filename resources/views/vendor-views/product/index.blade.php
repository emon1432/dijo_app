                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-sm-6 col-lg-4" id="maximum_cart_quantity">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number"  placeholder="{{ translate('messages.Eg:_10') }}"  class="form-control" name="maximum_cart_quantity" min="0" id="cart_quantity">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="time" name="available_time_starts" class="form-control"
                                                placeholder="{{ translate('messages.Eg:') }} 10:30 am" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlInput1">{{translate('messages.available_time_ends')}}</label>
                                        <input type="time" name="available_time_ends" class="form-control"  placeholder="{{ translate('messages.Eg:') }} 5:45 pm" required>
                                    </div>
                                </div>
                            </div>
                        </div>
