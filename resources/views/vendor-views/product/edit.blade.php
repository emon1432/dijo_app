                            ...
                            @endif
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" value="{{$product->price}}" min="0" max="999999999999" name="price"
                                                ...
                                                placeholder="{{ translate('messages.Eg:') }} 100" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" min="0" value="{{$product['discount']}}" max="100000"
                                                ...
                                                placeholder="{{ translate('messages.Eg:') }} 100">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-4">
                                    <div class="form-group mb-0">
                                ...
                                <div class="col-sm-6 col-lg-4" id="maximum_cart_quantity">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number"  placeholder="{{ translate('messages.Eg:_10') }}" class="form-control" name="maximum_cart_quantity" min="0" value="{{ $product->maximum_cart_quantity }}" id="cart_quantity">
                                    </div>
                                </div>
                            ...
                            <div class="row -2">
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="time" value="{{$product['available_time_starts']}}" name="available_time_starts" class="form-control" placeholder="{{ translate('messages.Eg:') }} 10:30 am" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
