                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input id="email"  type="email" name="email" class="form-control" placeholder="{{ translate('messages.Eg:') }} ex@example.com"
                                                required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div>
                                        ...
                                        <input type="text" id="identity_number" name="identity_number" class="form-control"
                                                placeholder="{{ translate('messages.Eg:') }} DH-23434-LS"
                                                required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4 col-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="input-group">
                                            <input type="tel" name="phone" id="phone" placeholder="{{ translate('messages.Eg:') }} 017********" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-12">
