                ...
                <div class="search--button-wrapper">
                    ...
                    <form class="search-form min--270">
                        ...
                        <div class="input-group input--group">
                            <input id="datatableSearch" type="search" value="{{ request()?->search ?? null }}" name="search" class="form-control" placeholder="{{ translate('messages.Eg:_Campaign title...') }}" aria-label="{{translate('messages.search_here')}}">
