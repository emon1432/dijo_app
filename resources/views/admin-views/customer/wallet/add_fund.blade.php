                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="{{translate('Eg: 50')}}" class="form-control" name="amount" min="0" id="amount" step=".01" required>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="{{ translate('Eg: 123') }}" class="form-control" name="referance" id="referance">
                            </div>
                        </div>
                    </div>
