                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-3 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="limit" id="coupon_limit" class="form-control" placeholder="EG: 10" min="1" max="100">
                                    </div>
                                </div>
                                <div class="col-md-4 col-lg-3 col-sm-6">
                                    <div class="form-group">
                        ...
                        <div class="search--button-wrapper">
                            ...
                            <form class="search-form min--270">
                                ...
                                <div class="input-group input--group">
                                    <input id="datatableSearch" type="search" name="search" value="{{ request()?->search ?? null }}" class="form-control" placeholder="{{ translate('messages.Eg:_Coupon_Title_Or_Code') }}" aria-label="{{translate('messages.search_here')}}">
