                                            ...
                                            <div class="col-md-3 col-12">
                                                <div class="form-floating">
                                                    ...
                                                    <input type="text" class="form-control" name="field_name[]"
                                                           placeholder="{{ translate('messages.Eg:_Bank')}}"
                                            ...
                                            <div class="col-md-3 col-12">
                                                <div class="form-floating">
                                                    ...
                                                    <input type="text" class="form-control" name="placeholder_text[]"
                                                           placeholder="{{ translate('messages.Eg:_John')}}"
                                ...
                                <div class="col-md-3 col-12">
                                    <div class="form-floating">
                                        <label>{{ translate('messages.field_name')}} <span
                                            class="input-label-secondary text-danger">*</span></label>
                                        <input type="text" class="form-control" name="field_name[]"
                                               placeholder="{{ translate('messages.Eg:_Bank')}}" value="" required>
                                    </div>
                                </div>
                                <div class="col-md-3 col-12">
                                    <div class="form-floating">
                                        <label>{{ translate('messages.placeholder_text')}} <span
                                            class="input-label-secondary text-danger">*</span></label>
                                        <input type="text" class="form-control" name="placeholder_text[]"
                                               placeholder="{{ translate('messages.Eg:_John')}}" value="" required>
                                    </div>
                                </div>
                                <div class="col-md-2 col-12">
                                    <div class="form-check">
