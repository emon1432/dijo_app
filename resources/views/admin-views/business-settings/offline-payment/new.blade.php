                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control text-break" id="method_name" placeholder="{{ translate('eg:_bkash') }}" name="method_name" required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-xl-4 col-sm-6">
                                        ...
                                        <div class="form-floating">
                                            <textarea class="form-control" name="payment_note" id="payment_note"
                                                placeholder="{{ translate('Eg:ABC_Company') }}"  disabled></textarea>
                                        </div>
                                    </div>
                                </div>
