                            ...
                            <div class="col-md-6">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <input id="name" type="text" name="name" class="form-control" placeholder="{{translate('Eg:  John Doe')}}">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="designation" class="form-label">{{translate('Designation')}}</label>
                                        <input id="designation" type="text" name="designation" class="form-control" placeholder="{{translate('Eg:  CTO')}}">
                                    </div>
                                    <div class="col-md-12">
