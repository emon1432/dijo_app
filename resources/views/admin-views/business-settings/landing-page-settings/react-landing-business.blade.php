                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="__bg-F8F9FC-card">
                                            <div class="form-group mb-md-0">
                                                ...
                                                <input id="seller_playstore_url" type="text" placeholder="{{translate('Eg: https://play.google.com/store/apps')}}" class="form-control h--45px" name="seller_playstore_url" value="{{ $download_app_links['seller_playstore_url']??''}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="__bg-F8F9FC-card">
                                            <div class="form-group mb-md-0">
                                                ...
                                                <input id="seller_appstore_url" type="text" placeholder="{{translate('Eg: https://www.apple.com/app-store/')}}" class="form-control h--45px" name="seller_appstore_url" value="{{ $download_app_links['seller_appstore_url']??''}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="__bg-F8F9FC-card">
                                            <div class="form-group mb-md-0">
                                                ...
                                                <input id="dm_playstore_url" type="text" placeholder="{{translate('Eg: https://play.google.com/store/apps')}}" class="form-control h--45px" name="dm_playstore_url" value="{{ $download_app_links['dm_playstore_url']??''}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="__bg-F8F9FC-card">
                                            <div class="form-group mb-md-0">
                                                ...
                                                <input id="dm_appstore_url" type="text" placeholder="{{translate('Eg: https://www.apple.com/app-store/')}}" class="form-control h--45px" name="dm_appstore_url" value="{{$download_app_links['dm_appstore_url']??''}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
