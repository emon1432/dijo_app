                            ...
                            <div class="col-md-6">
                                ...
                                <div class="__bg-F8F9FC-card">
                                    <div class="form-group mb-md-0">
                                        ...
                                        <input type="url" {{(isset($download_user_app_links) && $download_user_app_links['playstore_url_status'])?'required':''}} id="playstore_url" placeholder="{{translate('Eg: https://play.google.com/store/apps')}}" class="form-control h--45px" name="playstore_url" value="{{ $download_user_app_links['playstore_url']??''}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="__bg-F8F9FC-card">
                                    <div class="form-group mb-md-0">
                                        ...
                                        <input type="url" id="apple_store_url" {{(isset($download_user_app_links) && $download_user_app_links['apple_store_url_status'])?'required':''}} placeholder="{{translate('Eg: https://www.apple.com/app-store/')}}" class="form-control h--45px" name="apple_store_url" value="{{ $download_user_app_links['apple_store_url']??''}}">
                                    </div>
                                </div>
                            </div>
                        </div>
