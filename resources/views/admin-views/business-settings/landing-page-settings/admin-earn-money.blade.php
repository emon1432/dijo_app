                            ...
                            <div class="col-md-6">
                                ...
                                <div class="__bg-F8F9FC-card">
                                    <div class="form-group mb-md-0">
                                        ...
                                        <input id="playstore_url" type="url" placeholder="{{translate('Eg: https://play.google.com/store/apps')}}" class="form-control h--45px" name="playstore_url" value="{{ $seller_app_links['playstore_url'] ?? ''}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="__bg-F8F9FC-card">
                                    <div class="form-group mb-md-0">
                                        ...
                                        <input type="url" id="apple_store_url" placeholder="{{translate('Eg: https://www.apple.com/app-store/')}}" class="form-control h--45px" name="apple_store_url" value="{{ $seller_app_links['apple_store_url'] ?? ''}}">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="__bg-F8F9FC-card">
                                    <div class="form-group mb-md-0">
                                        ...
                                        <input id="playstore_url_dm" type="url" placeholder="{{translate('Eg: https://play.google.com/store/apps')}}" class="form-control h--45px" name="playstore_url" value="{{ $dm_app_links['playstore_url'] ?? ''}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="__bg-F8F9FC-card">
                                    <div class="form-group mb-md-0">
                                        ...
                                        <input id="apple_store_url_dm" type="url" placeholder="{{translate('Eg: https://www.apple.com/app-store/')}}" class="form-control h--45px" name="apple_store_url" value="{{ $dm_app_links['apple_store_url']?? ''}}">
                                    </div>
                                </div>
                            </div>
                        </div>
