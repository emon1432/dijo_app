                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="__bg-F8F9FC-card">
                                    ...
                                    <input id="company_button_name" type="text" maxlength="20" name="company_button_name[]" value="{{ $company_button_name?->getRawOriginal('value')??'' }}"  placeholder="{{translate('Eg: Order now')}}" class="form-control h--45px company_button_name" >
                                        </div>
                                    @foreach(json_decode($language) as $lang)
                                    <?php
                                    ...
                                    <input id="company_button_name{{$lang}}" type="text" maxlength="20" name="company_button_name[]" value="{{ $company_button_name_translate[$lang]['value']??'' }}"  placeholder="{{translate('Eg: Order now')}}" class="form-control h--45px company_button_name" >
                                        </div>
                                    @endforeach
                                @else
                                <div class="form-group">
                                    ...
                                    <input id="company_button_name" type="text" placeholder="{{translate('Eg: Order now')}}" class="form-control h--45px company_button_name" name="company_button_name[]" >
                                </div>
                                @endif
                                    <div class="form-group mb-md-0">
                                        ...
                                        <input type="url"  id="company_button_url" placeholder="{{translate('Eg: https://www.apple.com/app-store/')}}" class="form-control h--45px" name="company_button_url" value="{{ $company_button_url['value']??'' }}">
                                    </div>
                                </div>
                            </div>
                        </div>
