                                ...
                                <div class="row g-3">
                                    <div class="col-sm-12">
                                        <div class="form-group mb-0">
                                            ...
                                            <input id="name" type="text" placeholder="{{ translate('messages.Eg:') }} Alex" class="form-control" name="name"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-0">
                                            ...
                                            <input id="username" type="text" placeholder="{{ translate('messages.Eg:') }} ex@yahoo.com" class="form-control" name="username"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-0">
                                            ...
                                            <input id="email" type="text" placeholder="{{ translate('messages.Eg:') }} ex@yahoo.com" class="form-control" name="email"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-0">
                                            ...
                                            <input id="encryption" type="text" placeholder="{{ translate('messages.Eg:') }} tls" class="form-control" name="encryption"
