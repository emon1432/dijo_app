                                ...
                                @php($phone = \App\Models\BusinessSetting::where('key', 'phone')->first())
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="tel"  value="{{ $phone->value ?? '' }}"  id="phone"  name="phone"
                                            class="form-control" placeholder="{{ translate('messages.Eg: +3264124565') }}" required>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-4 col-xl-3">
                                    <div class="form-group mb-0">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-sm-12">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <textarea type="text" id="address" name="address" class="form-control h--90px" placeholder="{{ translate('messages.Eg: address') }}" rows="1" required>{{ $address->value ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" id="latitude" name="latitude" class="form-control"
                                                    placeholder="{{ translate('messages.Eg:') }} -94.22213"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" name="longitude" class="form-control"
                                                    placeholder="{{ translate('messages.Eg:') }} 103.344322" id="longitude"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" name="admin_commission" class="form-control"
                                            id="admin_commission" placeholder="{{ translate('messages.Eg:_10') }}"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        {{translate('messages.Commission_Rate_On_Delivery_Charge')}} (%)
                                            ...
                                            <input type="number" name="admin_comission_in_delivery_charge" class="form-control" id="admin_comission_in_delivery_charge"  placeholder="{{ translate('messages.Eg:_10') }}"
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number"  name="free_delivery_over" class="form-control"
                                            id="free_delivery_over"  placeholder="{{ translate('messages.Eg:_10') }}"
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="text" name="additional_charge_name" class="form-control"
                                                    id="additional_charge_name"  placeholder="{{ translate('messages.Eg:_Processing_Fee') }}"
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="number" name="additional_charge" class="form-control"
                                                    id="additional_charge"  placeholder="{{ translate('messages.Eg:_10') }}"
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="number" name="minimum_shipping_charge" class="form-control"
                                                    id="minimum_shipping_charge" min="0" step=".01"  placeholder="{{ translate('messages.Eg:_10') }}"
                                        ...
                                        <div class="col-sm-6 col-lg-4">
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <input type="number" name="per_km_shipping_charge" class="form-control"
                                                    id="per_km_shipping_charge" min="0" step=".01"  placeholder="{{ translate('messages.Eg:_100') }}"
