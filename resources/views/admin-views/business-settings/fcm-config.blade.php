...
{{--                                <textarea id="push_notification_key" name="push_notification_key" class="form-control" placeholder="{{translate('Eg: AAAAaBcDeFgHiJkLmNoPqRsTuVwXyZ0123456789')}}"--}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="d-flex">
                                    <input type="text" id="apiKey" value="{{$fcm_credentials['apiKey']??''}}"
                                        name="apiKey" class="form-control" placeholder="{{ translate('Eg: abcd1234efgh5678ijklmnop90qrstuvwxYZ') }}">
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex">
                                            <input id="projectId" type="text" value="{{$project_id->value??''}}"
                                                name="projectId" class="form-control" placeholder="{{ translate('Eg: my-awesome-app-12345') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex">
                                            <input id="authDomain" type="text" value="{{$fcm_credentials['authDomain']??''}}"
                                                name="authDomain" class="form-control" placeholder="{{ translate('Eg: my-awesome-app.firebase.com') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex">
                                            <input id="storageBucket" type="text" value="{{$fcm_credentials['storageBucket']??''}}"
                                                name="storageBucket" class="form-control" placeholder="{{ translate('Eg: my-awesome-app.apps.com') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex">
                                            <input id="messagingSenderId" type="text" value="{{$fcm_credentials['messagingSenderId'] ?? ''}}"
                                                name="messagingSenderId" class="form-control" placeholder="{{ translate('Eg: 1234567890') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex">
                                            <input id="appId" type="text" value="{{$fcm_credentials['appId']??''}}"
                                                name="appId" class="form-control" placeholder="{{ translate('Eg: 9876543210') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="d-flex">
                                            <input id="measurementId" type="text" value="{{$fcm_credentials['measurementId']??''}}"
                                                name="measurementId" class="form-control" placeholder="{{ translate('Eg: F-12345678') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
