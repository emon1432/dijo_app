                            ...
                            <div class="row">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="title[]" id="default_title"
                                                        class="form-control" placeholder="{{ translate('messages.Eg:_Xmas_Discounts') }}"
                                                    >
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="title[]" id="{{ $lang }}_title"
                                                                class="form-control" placeholder="{{ translate('messages.Eg:_EID_Dhamaka') }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
                                    ...
                                    @else
                                        <div id="default-form">
                                            <div class="form-group">
                                                ...
                                                placeholder="{{ translate('messages.Eg:_EID_Dhamaka') }}">
                                            </div>
                                            <input type="hidden" name="lang[]" value="default">
                                        </div>
                                    @endif
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" min="1" max="999999999999.99"  placeholder="{{ translate('messages.Eg:_100') }}"  name="bonus_amount" id="bonus_amount" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" min="1" max="999999999999.99" placeholder="{{ translate('messages.Eg:_10') }}" name="minimum_add_amount" id="minimum_add_amount" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" min="1" max="999999999999.99"  placeholder="{{ translate('messages.Eg:_1000') }}" name="maximum_bonus_amount" id="maximum_bonus_amount" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
