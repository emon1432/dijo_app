                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="time" name="available_time_starts" class="form-control"
                                            ...
                                            placeholder="{{ translate('messages.Eg:') }} 10:30 am">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group mb-0">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-sm-{{ Config::get('module.current_module_type') == 'food' ? '4' :'3' }} col-6" id="stock_input">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="number" placeholder="{{ translate('messages.Eg:_10') }}" class="form-control" name="current_stock" min="0" id="quantity">
                                    </div>
                                </div>
                                <div class="col-sm-{{ Config::get('module.current_module_type') == 'food' ? '4' :'3' }} col-6">
                                    <div class="form-group mb-0">
