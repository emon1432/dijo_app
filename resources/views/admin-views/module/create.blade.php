            ...
            <div class="card-body pb-0">
                ...
                <div class="lang_form p-1 mb-2" id="default-form">
                    <div class="form-group">
                        ...
                        <input type="text" name="module_name[]" class="form-control" maxlength="191" placeholder="{{ translate('messages.Eg:_Grocery,eCommerce,Pharmacy,etc.') }}">
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="module_name" class="form-control" value="{{old('name')}}" maxlength="191"  placeholder="{{ translate('messages.Eg:_business_Module Name') }}">
                </div>
                <div class="form-group">
