                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <input class="form-control" type="text" name="method" id="method" required maxlength="191" placeholder="{{translate('messages.EG_:_Card')}}">
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group mb-0">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <input class="form-control" type="number" min=".01" step="0.01" name="amount" id="amount" max="999999999999.99" placeholder="{{translate('messages.EG_:_1000')}}">
                        </div>
                    </div>
                    <div class="col-lg-12">
                    ...
                    <div class="search--button-wrapper">
                        ...
                        <form class="search-form theme-style">
                            <div class="input-group input--group">
                                <input id="datatableSearch" name="search" type="search" class="form-control h--40px" placeholder="{{translate('Eg:_Referance,_Name')}}" value="{{ request()?->search ?? null}}" aria-label="{{translate('messages.search_here')}}">
