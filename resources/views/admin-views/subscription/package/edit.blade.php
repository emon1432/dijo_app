                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" value="{{ $subscriptionackage->price }}" name="package_price" required  min="0.01" step="0.01" max="999999999" class="form-control" placeholder="{{ translate('Eg: 300') }}">
                            </div>
                        </div>
                        <div class="col-lg-4 col-sm-6">
                            <div class="form-group">
                                <label class="input-label">{{ translate('Package_Validity') }} {{ translate('Days') }}</label>
                                <input type="number"   min="1" max="999999999"  value="{{ $subscriptionackage->validity }}"  required name="package_validity"  class="form-control" placeholder="{{ translate('Eg: 365') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-sm-6 lang_form default-form" >
                            <div class="form-group m-0">
                                ...
                                <textarea class="form-control" placeholder="{{ translate('EG:_Value_for_money') }}"  name="text[]" id="package_info">{{ $subscriptionackage?->getRawOriginal('text')  }}</textarea>
                            </div>
                        </div>
                    ...
                    ?>
                        <div class="col-lg-4 col-sm-6 d-none lang_form" id="{{$lang}}-form1">
                            <div class="form-group m-0">
                                ...
                                <textarea class="form-control" name="text[]" placeholder="{{ translate('EG:_Value_for_money') }}" id="package_info">{{ $text[$lang]['text']??''}}</textarea>
                            </div>
                        </div>
                        @endforeach
                        @endif
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="d-flex flex-wrap items-center gap-2">
                                            ...
                                            <div class="custom-limit-box">
                                                <input id="max_order" type="number" value="{{ $subscriptionackage->max_order == 'unlimited' ? null : $subscriptionackage->max_order }}" name="max_order" min="1" step="1" max="999999999" class="form-control max_required" placeholder="{{ translate('Eg: 1000') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="limit-item-card">
                                    <div class="form-group mb-0">
                                        ...
                                        <div class="d-flex flex-wrap items-center gap-2">
                                            ...
                                            <div class="custom-limit-box">
                                                <input  id="max_product" type="number" value="{{ $subscriptionackage->max_product == 'unlimited' ? null : $subscriptionackage->max_product }}" name="max_product" min="1" step="1" max="999999999" class="form-control max_required" placeholder="{{ translate('Eg: 1000') }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
