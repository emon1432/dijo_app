                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number"   step="0.01" min="1" value="{{  $cashback->cashback_amount }}" max="{{ $cashback->cashback_type ==  'percentage' ? '100'  : '999999999.99' }}"  placeholder="{{ translate('messages.Eg:_100') }}"  name="cashback_amount" id="Cash_back_amount" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-6">
                            <div class="form-group">
                                ...
                                placeholder="{{ translate('messages.Eg:_100') }}">
                            </div>
                        </div>
                        <div class="col-md-4 col-lg-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" min="0" placeholder="{{ translate('messages.Eg:_100') }}"  max="999999999999.99"  {{ $cashback->cashback_type ==  'percentage' ? 'required'  : 'readonly' }}   value="{{ $cashback->max_discount }}" name="max_discount" id="max_discount" class="form-control" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-lg-4 col-sm-6">
                            <div class="form-group">
                                ...
                                placeholder="{{ translate('messages.Eg:_5') }}">
                            </div>
                        </div>
