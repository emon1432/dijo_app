                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{  old('cashback_amount') }}" step="0.01" min="1" max="100"  placeholder="{{ translate('messages.Eg:_100') }}"  name="cashback_amount" id="Cash_back_amount" class="form-control" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number"   placeholder="{{ translate('messages.Eg:_100') }}" step="0.01" min="0" value="{{  old('cashback_type')  == 'percentage' ?  old('max_discount') : null }}" max="999999999999.99" name="max_discount" id="max_discount" class="form-control">
                                    </div>
                                </div>
