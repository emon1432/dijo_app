    ...
    @endphp
        ...
        data-original-title="{{translate('messages.store_lat_lng_warning')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.store_lat_lng_warning')}}"></span></label>
                                        <input type="text" id="latitude"
                                                ...
                                                placeholder="{{ translate('messages.Eg:') }} -94.22213" value="{{$store->latitude}}" required readonly>
                                    </div>
        ...
        data-original-title="{{translate('messages.store_lat_lng_warning')}}"><img src="{{asset('/public/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.store_lat_lng_warning')}}"></span></label>
                                        <input type="text"
                                                ...
                                                placeholder="{{ translate('messages.Eg:') }} 103.344322" id="longitude" value="{{$store->longitude}}" required readonly>
                                    </div>
                                </div>
                                <div class="col-lg-8">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        placeholder="{{ translate('messages.Eg:') }} 017********" value="{{$store->vendor->phone}}"
                                        required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="email" name="email" class="form-control" placeholder="{{ translate('messages.Eg:') }} ex@example.com" value="{{$store->email}}" required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
