                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="increased_delivery_fee" class="form-control"
                                ...
                                step=".001" placeholder="{{ translate('messages.Eg:_100') }}" {{ ($zone->increased_delivery_fee_status == 1) ? ' ' : 'readonly' }}>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="increase_delivery_charge_message" class="form-control"
                                ...
                                value="{{ $zone->increase_delivery_charge_message ? $zone->increase_delivery_charge_message : '' }}"
                                    placeholder="{{ translate('messages.Eg:_Rainy_season') }} " {{ ($zone->increased_delivery_fee_status == 1) ? ' ' : 'readonly' }}>
                        </div>
                    </div>
                </div>
